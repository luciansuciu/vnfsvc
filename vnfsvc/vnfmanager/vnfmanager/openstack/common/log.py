...
from vnfmanager.openstack.common import jsonutils
from vnfmanager.openstack.common import local
...
# NOTE(anirudh): to be added for enumerating multiple same service logs
def _generate_enumeration(binary):
    if binary in bin_list:
       return bin_dict[binary]+1
    else:
