...
"""
Routines for configuring VNFManager
"""
...
core_opts = [
    ...
    cfg.StrOpt('core_plugin',
               help=_("The core plugin VNFManager will use")),
    ...
    cfg.StrOpt('host', default=utils.get_hostname(),
               help=_("The hostname VNFManager is running on")),
    cfg.StrOpt('nova_url',
...
messaging.set_transport_defaults(control_exchange='vnfmanager')
...
def init(args, **kwargs):
    cfg.CONF(args=args, project='vnfmanager',
