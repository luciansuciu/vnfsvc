...
def find_config_file(options, config_file):
    ...
    * Search for the configuration files via common cfg directories
    ...
    config_file_dirs = [fix_path(os.path.join(os.getcwd(), 'etc')),
                        fix_path(os.path.join('~', '.vnfmanager-venv', 'etc',
                                              'vnfmanager')),
                        fix_path('~'),
                        os.path.join(cfg.CONF.state_path, 'etc'),
                        os.path.join(cfg.CONF.state_path, 'etc', 'vnfmanager'),
                        fix_path(os.path.join('~', '.local',
                                              'etc', 'vnfmanager')),
                        '/usr/etc/vnfmanager',
                        '/usr/local/etc/vnfmanager',
                        '/etc/vnfmanager/',
                        '/etc']

    if 'plugin' in options:
        config_file_dirs = [
            os.path.join(x, 'vnfmanager', 'plugins', options['plugin'])
